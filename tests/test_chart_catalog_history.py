...
def test_catalog_refresh_excludes_ourbit_opportunities(tmp_path, monkeypatch) -> None:
    """Adapters remain available, but opportunity enumeration obeys policy."""
    ...
    assert ("Ourbit", "Futures") not in seen
