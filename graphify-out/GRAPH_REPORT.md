...
## Corpus Check
- 70 files · ~157,954 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2985 nodes · 7265 edges · 44 communities detected
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 254 edges (avg confidence: 0.71)
...
Cohesion: 0.01
Nodes (81): a(), ae, ai, At, b(), bi(), Bt, c() (+73 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (26): bn(), ct, En, g(), gi, gn, gs(), ii() (+18 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (331): active_class(), api_alert_context(), api_alert_preview(), api_board(), api_community(), api_funding_watch(), api_health(), api_history() (+323 more)
...
Cohesion: 0.06
Nodes (11): an(), cn(), dn(), fn(), hn(), j, on, rn() (+3 more)
...
## Knowledge Gaps
- **317 isolated node(s):** `HTTP boundary for crypto checkout.  The subtle failure this guards against: memb`, `The tutorial must be reachable without an account -- it is a conversion page.`, `Crypto (Arbitrum USDC/USDT) prepaid billing.  The invariant that matters most: a`, `Dollars -> raw 6-decimal token units.`, `An exchange withdrawal fee must not cost the member their access.` (+312 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 23`** (19 nodes): `BaseHTTPRequestHandler`, `SpreadBoardHandler`, `._authorize()`, `.do_HEAD()`, `.do_POST()`, `._handle_login()`, `._handle_register()`, `.log_message()`, `._read_payload()`, `._read_raw_body()`, `._redirect()`, `._require_csrf()`, `._required_user()`, `._send_asset()`, `._send_empty()`, `._send_html()`, `._send_json()`, `._send_security_headers()`, `._session_token()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 30`** (12 nodes): `di()`, `o`, `.constructor()`, `.hi()`, `.ht()`, `.i()`, `.m()`, `.p()`, `.st()`, `.$t()`, `.u()`, `.v()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `FastQuoteRefresher` connect `Community 8` to `Community 24`, `Community 2`, `Community 23`, `Community 15`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `CryptoBillingError` connect `Community 10` to `Community 12`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `spread_pct()` connect `Community 3` to `Community 8`?**
