...
## Corpus Check
- 70 files · ~157,207 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2950 nodes · 7214 edges · 49 communities detected
...
Cohesion: 0.01
Nodes (76): a(), ae, ai, an(), as(), At, b(), bi() (+68 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (32): _(), bn(), ct, e(), En, g(), gi, gn (+24 more)
...
Cohesion: 0.03
Nodes (8): ar(), be, di(), ds(), ii(), o, ws(), yi
...
Cohesion: 0.03
Nodes (13): es(), is(), js(), l(), ni(), nt, qs(), se (+5 more)
...
Cohesion: 0.06
Nodes (10): cn(), dn(), fn(), hn(), j, on, rn(), u() (+2 more)
...
Cohesion: 0.06
Nodes (11): fs(), ms(), mt, re, s(), st, vs(), x() (+3 more)
...
## Knowledge Gaps
- **297 isolated node(s):** `HTTP boundary for crypto checkout.  The subtle failure this guards against: memb`, `The tutorial must be reachable without an account -- it is a conversion page.`, `Crypto (Arbitrum USDC/USDT) prepaid billing.  The invariant that matters most: a`, `Dollars -> raw 6-decimal token units.`, `An exchange withdrawal fee must not cost the member their access.` (+292 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 24`** (20 nodes): `.constructor()`, `.detach()`, `.width()`, `.detachPrimitive()`, `.ca()`, `.detached()`, `q()`, `.detachPrimitive()`, `we`, `.applyOptions()`, `.constructor()`, `.detach()`, `.et()`, `.getSeries()`, `.ht()`, `.jp()`, `._M()`, `.mM()`, `.oM()`, `.uM()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 42`** (4 nodes): `f()`, `.constructor()`, `.ht()`, `.st()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (3 nodes): `main()`, `configure_telegram_webhook.py`, `telegram_call()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 45`** (3 nodes): `main()`, `configure_stripe_webhook.py`, `stripe_request()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (2 nodes): `Spread arbitrage research bot.`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (2 nodes): `__init__.py`, `Utility helpers for spreadarb.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (2 nodes): `Narrow live-operation helpers.  The main live engine remains locked. Modules in`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 51`** (2 nodes): `Read-only decentralized exchange integrations.`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 52`** (2 nodes): `Read-only API discovery for Telegram opportunity visibility.  The package is int`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `FastQuoteRefresher` connect `Community 5` to `Community 2`, `Community 12`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `WatchAsset` connect `Community 3` to `Community 8`, `Community 7`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `SpreadTerminalRow` connect `Community 7` to `Community 3`?**
