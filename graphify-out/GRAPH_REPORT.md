...
## Corpus Check
- 70 files · ~153,883 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2873 nodes · 7107 edges · 45 communities detected
...
Cohesion: 0.01
Nodes (54): _(), a(), an(), ar(), as(), bi(), bn(), bs() (+46 more)
...
Cohesion: 0.01
Nodes (54): At, b(), be, Bt, c(), d(), De(), di() (+46 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (16): ae, ai, ci, ct, gt, je(), kt(), l() (+8 more)
...
Cohesion: 0.03
Nodes (12): ee(), ht, ir, Ks, lr, ot, ps(), tn() (+4 more)
...
Cohesion: 0.04
Nodes (10): es(), is(), jn(), qn(), rr(), se, ss, tt (+2 more)
...
## Knowledge Gaps
- **246 isolated node(s):** `HTTP boundary for crypto checkout.  The subtle failure this guards against: memb`, `Crypto (Arbitrum USDC/USDT) prepaid billing.  The invariant that matters most: a`, `Dollars -> raw 6-decimal token units.`, `An exchange withdrawal fee must not cost the member their access.`, `A token calling itself USDC must not buy access.` (+241 more)
...
- **Why does `WatchAsset` connect `Community 2` to `Community 11`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `_release_ccxt_exchange()` connect `Community 2` to `Community 5`?**
