...
## Corpus Check
- 70 files · ~157,490 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2971 nodes · 7240 edges · 46 communities detected
...
Cohesion: 0.01
Nodes (41): _(), a(), ar(), as(), bn(), ds(), e(), En (+33 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (52): ae, ai, At, bi(), bs(), ci, ct, dt (+44 more)
...
Cohesion: 0.01
Nodes (58): an(), b(), Bt, c(), cn(), d(), De(), di() (+50 more)
...
Cohesion: 0.04
Nodes (8): ce, ee(), hr, ir, Ks, tr, ve, we
...
## Knowledge Gaps
- **312 isolated node(s):** `HTTP boundary for crypto checkout.  The subtle failure this guards against: memb`, `The tutorial must be reachable without an account -- it is a conversion page.`, `Crypto (Arbitrum USDC/USDT) prepaid billing.  The invariant that matters most: a`, `Dollars -> raw 6-decimal token units.`, `An exchange withdrawal fee must not cost the member their access.` (+307 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 21`** (19 nodes): `BaseHTTPRequestHandler`, `SpreadBoardHandler`, `._authorize()`, `.do_HEAD()`, `.do_POST()`, `._handle_login()`, `._handle_register()`, `.log_message()`, `._read_payload()`, `._read_raw_body()`, `._redirect()`, `._require_csrf()`, `._required_user()`, `._send_asset()`, `._send_empty()`, `._send_html()`, `._send_json()`, `._send_security_headers()`, `._session_token()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (7 nodes): `be`, `.CM()`, `.constructor()`, `.dM()`, `.draw()`, `.et()`, `.ht()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (3 nodes): `main()`, `configure_telegram_webhook.py`, `telegram_call()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 42`** (3 nodes): `main()`, `configure_stripe_webhook.py`, `stripe_request()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 45`** (2 nodes): `Spread arbitrage research bot.`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (2 nodes): `__init__.py`, `Utility helpers for spreadarb.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 47`** (2 nodes): `Narrow live-operation helpers.  The main live engine remains locked. Modules in`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (2 nodes): `Read-only decentralized exchange integrations.`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (2 nodes): `Read-only API discovery for Telegram opportunity visibility.  The package is int`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `FastQuoteRefresher` connect `Community 5` to `Community 2`, `Community 21`, `Community 14`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `WatchAsset` connect `Community 4` to `Community 6`, `Community 7`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `SpreadTerminalRow` connect `Community 6` to `Community 4`?**
