...
Both services844095e/b7d64b77a9869b05 verified by guarded deploy exit0, source parity and warm health/free200 (208948 priced routes). Bounded pressure trim permits20s allocator cleanup above2.5GiB while retaining60s regular trim,180s fullGC and live caches.2921tests passed200.25s; exact required tests/ command also2921passed200.92s. Canonical Ruff ratchet passes500known/no new. Ordinary WhiteBIT catalogue revision4 verified398 futures/487spot,93tokenized; history recovery309ok/89pending at04:17UTC, further recovery not yet certified. Observer2480414 restarted warm04:24:50UTC,49h/50h limit, same append-only unit. Startup1.28min peak web2036.3MiB/collector2108.7MiB is not cap evidence. Accounting512MiB; app3584/collector4096 unchanged. Final hour/48h, ordinary discovery memory cycle, remaining funding catch-up and two normal backups remain open; next backup06:21:05UTC. No trading, external messages, alert reactivation or recurring automation.
