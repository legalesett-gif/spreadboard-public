...
## SpreadBoard stability and UA comparison — Codex continuation (2026-09-06, 01:09 UTC)

- Goal ACTIVE. This turn made verified progress: counts/pagination, exact sorting and grouped positive-carry visibility fixed and deployed. CAP's exact comparator pair is now visible in Funding after ordinary catalogue rotation. Do not mark blocked or complete. No subagents, trades, messages, spend, Pushover, cap increases or weaker accuracy/freshness/identity/settlement guards.
- Current isolated checkout: `tmp/spreadboard-collector-retention`, branch `codex/collector-retention-20260906`. Other accounting checkout/source c115414 and dirty funding-current-truth work remain untouched. Work only in this checkout; accounting container remains its separate release.
- LIVE app/collector **feffc48 / c4628f117bfe0caf**, started **01:05:11 UTC Sep6**. Deploy exit0, health200, exact digest parity. Fresh01:08 both healthy, restarts0, OOMfalse. App ID ab0991b3bb3ae462f1dc6c86f24ae4be399437f6f44150917720f3e80da7314a; collector e01a9f25a32cb8014feaef1e7fc68df23a1d99666baf1955f3434be4db407b20. Both discovery AND finalizer absent before deployment and immediately before recreation; no force. Also allowed the chart-catalog worker to finish before final deployment.
...
- BACKUP still NOT ACCEPTED: scheduled job00:19:49UTC remainsactivating/MainPID336267 at01:08. ExecMainStatus0is an in-progress default, notsuccess. Earlier8GoogleDrive rateLimitExceeded/403s and slowrcloneIO; customOAuthclient absent, noTPSlimit; jobTimeoutStart=infinity. Official rclone Drive docs say shared client retirement during2026 and recommend own client. No config changes, process interruption or concurrent repository mutation this turn. Need safe bounded failure/throughput investigation and successful normal backup/prune/check; may require operator-owned OAuth client setup. Preserve secrets and existing retention.
- Outstanding: cold Funding navigation; small exact-page labels and advanced-filter consistency review; final-release30samples/hour±10%, ordinary heavy/history/navigation cycles, safe lower caps and clean48h; successful backup; bounded bidirectional UA comparison evidence. Do not declare complete from tests or one healthy sample.
